...
br.getPageURI = function(index, reduce, rotate) {
	...
	if(level == 1)
	{
		...
		console.log("hello inside level 1");
		br.showProgressPopup('<img id="searchmarker" src="'+this.imagesBaseURL + 'marker_srch-on.png'+'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Loading...');
		$.ajax({type: "POST", url: "../templates/bgconvert.php?level="+level+"&index="+index+"&volume="+book.volume+"&imgurl="+book.imgurl+"&mode="+this.mode+"&part="+book.part+"&vtype="+book.vtype, async: true , success :function(data){br.updater(data);} , data : {book:this.book.imglist}});
		return br.imagesBaseURL + "transparent.png";
	}
	else
	{
		$.ajax({type: "POST", url: "../templates/bgconvert.php?level="+level+"&index="+index+"&volume="+book.volume+"&imgurl="+book.imgurl+"&mode="+this.mode+"&part="+book.part+"&vtype="+book.vtype, async: true , data : {book:this.book.imglist}});
